...
* check for longest periods of negative vs longest periods of positive
* check ave pos vs ave neg, distribution
* what % of the time do you lose money on YoY basis?
* note that as of most recent data, still above water for yearly return - but getting close to underwater