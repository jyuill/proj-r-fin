...
```{r, fig.height=3, width=3.5}
## print price and cost table - using formattable functions to format numbers
acb_price_all %>% ggplot(aes(x=symb, y=diff))+geom_col()+
  scale_y_continuous(labels=percent)+
  labs(title="Price vs Avg Cost", x="", y="% Diff: Price to ACB")
